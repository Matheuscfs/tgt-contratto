...
export default function CategoryGrid({ categories, onSelectCategory, onSelectAll }: CategoryGridProps) {
  return (
    <div className="py-4">
      <div className="flex space-x-4 overflow-x-auto pb-3 -mx-4 px-4" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
        ...
        <button onClick={onSelectAll} className="flex flex-col items-center justify-start space-y-2 flex-shrink-0 w-20 text-center group">
          <div className="w-16 h-16 rounded-full flex items-center justify-center p-3 transition-colors group-hover:bg-gray-100">
